...
import org.firstinspires.ftc.teamcode.bedroBathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.bedroBathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.bedroBathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 78.2744;
    private static double yMovement = 66.9288;
    ...
    public static double drivePIDFFeedForward = 0.007;
    ...
    public static double mass = 10.8;
    ...
    public static double forwardZeroPowerAcceleration = -33.4116;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -68.9847;

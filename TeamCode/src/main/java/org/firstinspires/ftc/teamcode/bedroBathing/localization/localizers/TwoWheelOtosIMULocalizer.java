...
import org.firstinspires.ftc.teamcode.bedroBathing.localization.Encoder;
import org.firstinspires.ftc.teamcode.bedroBathing.localization.Localizer;
import org.firstinspires.ftc.teamcode.bedroBathing.localization.Matrix;
...
import org.firstinspires.ftc.teamcode.bedroBathing.util.NanoTimer;
 ...
 */
@Config
public class TwoWheelOtosIMULocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = .001975972178;
    public static double STRAFE_TICKS_TO_INCHES = .001992587574; //-.00272479
     ...
     */
    public TwoWheelOtosIMULocalizer(HardwareMap map) {
        this(map, new Pose());
    }
     ...
     */
    public TwoWheelOtosIMULocalizer(HardwareMap map, Pose setStartPose) {
        // TODO: replace these with your encoder positions
        forwardEncoderPose = new Pose(2, 1.25, 0);
        strafeEncoderPose = new Pose(1.75, -1.5, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "motorLF"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "motorRR"));
